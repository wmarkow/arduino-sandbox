...
<img src="doc/HC-12/HC-12_pinout.jpg" width="75%" >
...
<img src="doc/spectrum/understanding_2FSK_spectrum.png" width="75%" >

Experiments with the configuration file (radio_config_Si4438.h) generated by **WSD3** sofware shows the following:
 1. **RF Freq.(MHz)** is the end frequency of the communication channel (it is not the center frequency of the channel!)
 2. **fhst** is the width (in Hz) of the channel
 3. **Fdev[Hz]** is the deviation of 2FSK modulation. It is defined as a distance between channel's center frequency and each tranmsitted symbol

This rules are important to be aware of to correctly match the transmission frequency with the frequency that needs to be entered to the receiver
radio (i.e. Yaesu, Baofeng, Quansheng, etc).
